...
"""
    ...
    *Permite el reconocimiento de distintos tokes usando expresiones regulares para un lenguajes de múltiples instrucciones por línea de código. Este programa no posee lexema de palabras especiales, en su lugar, reconocerá identificadores de usuario, valores númericos, cadenas, fin de instrucción y saltos de línea.
    *Esta implementación no aplica el uso de "automatas finitos", lo que hacer la implementación sea completamente demostrativa.
    *Es por ello que esta demostración representa un ejemplo informal para realizar el proceso de detección de tokens, sobre el cual se hacen mención de aspectos especificos de la teoría pero no se aplican en completitud las prácticas obligatorias de la literatura, para encajar en una demostración dentro de la hora clase.
